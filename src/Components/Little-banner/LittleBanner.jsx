const LittleBanner = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-10
         mx-auto lg:grid-cols-4 px-32 items-center py-10 bg-[#ECEAE3]">

            {/* first card */}
            <div className="space-y-3">
                <img className="w-[70px] h-[70px]" src="https://i.ibb.co/44xBR6y/1.png" alt="" />
            ...
            {/* secant card */}
            <div className="space-y-3">
                <img className="w-[70px] h-[70px]" src="https://i.ibb.co/GkKZgkx/2.png" alt="" />
            ...
            {/* third card */}
            <div className="space-y-3">
                <img className="w-[70px] h-[70px]" src="https://i.ibb.co/gSFb1JS/3.png" alt="" />
            ...
            {/* four card */}
            <div className="space-y-3">
                <img className="w-[70px] h-[70px]" src="https://i.ibb.co/nRfzLxJ/4.png" alt="" />
