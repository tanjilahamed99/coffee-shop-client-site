...
const Footer = () => {
    ...
    return (
        <footer className=" flex mx-auto items-center p-10 mt-10   w-full
        bg-[url('https://i.ibb.co/fYz7JxR/13.jpg')] bg-cover bg-center bg-no-repeat ">
            ...
            <div className="w-[50%]">
                ...
                <input className="w-[70%] h-10 px-3 rounded-lg" placeholder="name" type="text" />
                <input className="w-[70%]  h-10 my-4 px-4 rounded-lg" type="text" placeholder="email" />
                <textarea className="textarea textarea-bordered w-[70%] block" placeholder="Message"></textarea>
